...
let DataService = class DataService {
     ...
     */
    recupererDonneesSpeakersApiDevFest() {
        return this.httpClient.get(`${URL_API_DEVFEST}/speakers`)
            .pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_4__["map"])(speakers => Object.values(speakers)));
    }
    /**
     ...
     */
    recupererDonneesSessionsApiDevFest() {
        return this.httpClient.get(`${URL_API_DEVFEST}/sessions`)
            .pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_4__["map"])(sessions => Object.values(sessions)));
    }
    /**
     ...
     */
    recupererDonneesScheduleApiDevFest() {
     ...
     * @return : Observable<Session[]> observable du tableau des sessions
     */
    recupererDonneesSessions() {
        if (!localStorage.getItem('sessionsData')) {
            return this.recupererDonneesSessionsApiDevFest().pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_4__["tap"])((donnees) => {
     ...
     * @return : Observable<Speaker[]> observable du tableau des présentateurs
     */
    recupererDonneesSpeakers() {
        if (!localStorage.getItem('speakersData')) {
            return this.recupererDonneesSpeakersApiDevFest().pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_4__["tap"])((donnees) => {
