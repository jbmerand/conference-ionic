...
var URL_API_DEVFEST = 'https://devfest-nantes-2018-api.cleverapps.io';
/**
...
var DataService = /** @class */ (function () {
     ...
     */
    DataService.prototype.recupererDonneesSpeakersApiDevFest = function () {
        return this.httpClient.get(URL_API_DEVFEST + "/speakers")
            .pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_4__["map"])(function (speakers) { return Object.values(speakers); }));
    };
    /**
     ...
     */
    DataService.prototype.recupererDonneesSessionsApiDevFest = function () {
        return this.httpClient.get(URL_API_DEVFEST + "/sessions")
            .pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_4__["map"])(function (sessions) { return Object.values(sessions); }));
    };
    /**
     ...
     */
    DataService.prototype.recupererDonneesScheduleApiDevFest = function () {
        return this.httpClient.get(URL_API_DEVFEST + "/schedule");
    };
    /**
     ...
     * @return : Observable<Session[]> observable du tableau des sessions
     */
    DataService.prototype.recupererDonneesSessions = function () {
        if (!localStorage.getItem('sessionsData')) {
            return this.recupererDonneesSessionsApiDevFest().pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_4__["tap"])(function (donnees) {
                localStorage.setItem('sessionsData', JSON.stringify(donnees));
            }));
        }
        else {
            return Object(rxjs__WEBPACK_IMPORTED_MODULE_2__["of"])(JSON.parse(localStorage.getItem('sessionsData')));
        }
    };
    /**
     * Sollicite les données dans le cache ou lance la méthode qui fait une
     ...
     * @return : Observable<Speaker[]> observable du tableau des présentateurs
     */
    DataService.prototype.recupererDonneesSpeakers = function () {
        if (!localStorage.getItem('speakersData')) {
            return this.recupererDonneesSpeakersApiDevFest().pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_4__["tap"])(function (donnees) {
                localStorage.setItem('speakersData', JSON.stringify(donnees));
            }));
        }
        else {
            return Object(rxjs__WEBPACK_IMPORTED_MODULE_2__["of"])(JSON.parse(localStorage.getItem('speakersData')));
        }
    };
