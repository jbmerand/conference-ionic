...
var HomePage = /** @class */ (function () {
    ...
    HomePage.prototype.ngOnInit = function () {
        ...
        if (!localStorage.getItem('scheduleData')) {
            this.dataService.recupererDonneesScheduleApiDevFest().subscribe(function (donnees) {
                localStorage.setItem('scheduleData', JSON.stringify(donnees));
                _this.scheduleData = donnees;
                _this.dateDebutConf = _this.scheduleData[0].dateReadable;
                _this.dateFinConf = _this.scheduleData[_this.scheduleData.length - 1].dateReadable;
            });
        }
