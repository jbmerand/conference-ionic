...
var routes = [
    ...
    {
        path: ':id',
        loadChildren: function () { return __webpack_require__.e(/*! import() | session-session-module */ "session-session-module").then(__webpack_require__.bind(null, /*! ./session/session.module */ "./src/app/sessions/session/session.module.ts")).then(function (m) { return m.SessionPageModule; }); }
    }
];
...
var SessionsPage = /** @class */ (function () {
     ...
     */
    function SessionsPage(dataService) {
    ...
    SessionsPage.prototype.ngOnInit = function () {
        ...
        this.dataService.recupererDonneesSessions().subscribe((function (sessions) {
            ...
            _this.sessionsData = sessions;
        }), (function () { return _this.isErreurRecuperationSessions = true; }));
    };
    SessionsPage.ctorParameters = function () { return [
