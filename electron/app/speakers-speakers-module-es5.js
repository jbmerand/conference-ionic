...
var routes = [
    ...
    {
        path: ':id',
        loadChildren: function () { return __webpack_require__.e(/*! import() | speaker-speaker-module */ "speaker-speaker-module").then(__webpack_require__.bind(null, /*! ./speaker/speaker.module */ "./src/app/speakers/speaker/speaker.module.ts")).then(function (m) { return m.SpeakerPageModule; }); }
    }
];
...
var SpeakersPage = /** @class */ (function () {
     ...
     */
    function SpeakersPage(dataService) {
        this.dataService = dataService;
        this.urlBlogDevFest = 'https://devfest2018.gdgnantes.com/';
    }
    SpeakersPage.prototype.ngOnInit = function () {
        var _this = this;
        this.dataService.recupererDonneesSpeakers().subscribe((function (presentateurs) {
            _this.isErreurRecuperationPresentateurs = false;
            _this.presentateursData = presentateurs;
        }), (function () { return _this.isErreurRecuperationPresentateurs = true; }));
    };
    SpeakersPage.ctorParameters = function () { return [
...
//# sourceMappingURL=speakers-speakers-module-es5.js.map