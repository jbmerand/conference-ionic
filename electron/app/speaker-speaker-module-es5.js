...
var SpeakerPageModule = /** @class */ (function () {
    function SpeakerPageModule() {
    }
...
var SpeakerPage = /** @class */ (function () {
     ...
     */
    function SpeakerPage(dataService, route) {
     ...
     */
    SpeakerPage.prototype.recupererLesDonnees = function () {
        var _this = this;
        this.dataService.recupererDonneesSpeakers().subscribe((function (speakers) {
            _this.isErreurRecuperationPresentateur = false;
            _this.presentateurData = speakers
                .find(function (speaker) { return speaker.id.toString() === _this.presentateurId; });
            _this.dataService.recupererDonneesSessions().subscribe((function (sessions) {
                _this.isErreurRecuperationSessions = false;
                sessions.forEach(function (session) {
                    if (session.speakers && session.speakers
                        .includes(parseInt(_this.presentateurId, 10))) {
                        _this.sessionsData.push(session);
                    }
                });
            }), (function () { return _this.isErreurRecuperationSessions = true; }));
        }), function () { return _this.isErreurRecuperationPresentateur = true; });
    };
    SpeakerPage.prototype.ngOnInit = function () {
        this.route.paramMap.subscribe(function (params) {
            var sessionId = params.get('id');
        });
        this.recupererLesDonnees();
    };
    SpeakerPage.ctorParameters = function () { return [
...
//# sourceMappingURL=speaker-speaker-module-es5.js.map